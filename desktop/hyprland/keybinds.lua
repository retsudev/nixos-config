...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("serpantinum msg toggle wallpaper"))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("serpantinum msg toggle calendar"))
...
hl.bind(mainMod .. " + G", hl.dsp.exec_cmd("serpantinum msg toggle guide"))
